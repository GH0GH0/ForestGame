...
bool collision::CercleCercle(Obstacle obstacle, Personnage perso)//collision entre l'obsacle et le personnage qui sont representé comme deux cercle avec leur diametre
{
...
{
	int distanceX = perso1.getX - perso2.getX;
	int distanceY = perso1.getY - perso2.getY;
