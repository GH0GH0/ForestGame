...
bool collision::CercleCercle(Obstacle obstacle, Personnage perso)//collision entre l'obstacle et le personnage qui sont represent� comme deux cercle avec leur diametre
{
